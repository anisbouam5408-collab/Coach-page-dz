...
const ar = {
  ...
  "auth.register.usernameHint": "بحروف إنجليزية وأرقام فقط، بدون مسافات (مثال: ahmed_coach)",
...
const fr: Record<Key, string> = {
  ...
  "auth.register.usernameHint": "Lettres anglaises et chiffres uniquement, sans espaces (ex : ahmed_coach)",
